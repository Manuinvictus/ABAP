@AbapCatalog.sqlViewName: 'ZV_BOOKING_MCS'
@AbapCatalog.compiler.compareFilter: true
@AbapCatalog.preserveKey: true
@AccessControl.authorizationCheck: #NOT_REQUIRED
@EndUserText.label: 'Definición de datos para las reservas'
...
define root view ZI_BOOKING_MCS 
   as select from ztbooking_mcs as Booking
